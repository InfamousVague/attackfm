 ...
 *
 * The placeholder itself, and the `pending:` path scheme that marks one, are
 * in `pendingTrack.ts` - the search and discover screens mint one without
 * ever mounting the provider below.
 */
