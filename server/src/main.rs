...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/jams/invite", post(jams::invite))
        .route("/api/jams/invite/accept", post(jams::accept_invite))
        .route("/api/jams/invite/decline", post(jams::decline_invite))
        ...
        .route("/api/jams/{id}/control", post(jams::control))
        ...
        .route("/api/ai/voices", get(ai_admin::voices))
